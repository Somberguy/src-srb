...
public class ExceptionHandlerConfigration {


    @ExceptionHandler(ServiceException.class)
    public R serviceExceptionHandler(ServiceException serviceException){
        return R.error().resetCode(serviceException.getCode()).resetMessage(serviceException.getMessage());
    }
    ...
    public R handleServletException(Exception e) {
        ...
        return R.error().resetCode(ResponseEnum.SERVLET_ERROR.getCode()).resetMessage(ResponseEnum.SERVLET_ERROR.getMessage());
    }
}
