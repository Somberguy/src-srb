package com.tanbo.srb.sms.service.impl;
...
import com.tanbo.srb.sms.service.SmsService;
...
public class SmsServiceImpl implements SmsService {
    ...
    public void send(String mobile, String templateCode, Map<String,Object> param) {
        ...
        DefaultProfile profile = DefaultProfile.getProfile(
                AliyunSMSConfigrationProperties.REGION_Id,
                AliyunSMSConfigrationProperties.KEY_ID,
                AliyunSMSConfigrationProperties.KEY_SECRET);
        ...
        request.putQueryParameter("RegionId", AliyunSMSConfigrationProperties.REGION_Id);
        request.putQueryParameter("PhoneNumbers", mobile);
        request.putQueryParameter("SignName", AliyunSMSConfigrationProperties.SIGN_NAME);
        ...
        try {
            ...
            throw new ServiceException(ResponseEnum.ALIYUN_SMS_ERROR , e);
